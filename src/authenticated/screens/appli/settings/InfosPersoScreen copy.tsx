...
function InfosPersoScreen() {
  ...
  const [image, setImage] = useState<string | number>(
    require("./../../../../assets/images/userHead.png")
  );
    ...
    const fetchData = async () => {
      ...
      if (docSnap.exists()) {
        ...
        if (userData.imageUrl) {
          ...
          userContext?.setImageUrl(""); // Définir l'URL de l'image dans le contexte à une chaîne vide si elle est indéfinie
          setImage(require("./../../../../assets/images/userHead.png")); // Définir l'image par défaut si l'URL de l'image est indéfinie
        }
      }
    };
